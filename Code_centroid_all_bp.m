...
%cd C:\Users\mona.nashashibi\Work\Matlab\Tests\Code_entier % folder in which all csv files to analyze are stored (remove all other csv files)
cd C:\Users\sirenia.mondragon\Desktop\M45\C4\C4_centroid % path to files
destination_path = 'C:\Users\sirenia.mondragon\Desktop\M45\C4\C4_centroid'; % Where to save results 
